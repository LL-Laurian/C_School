...
#include "MDB-1008831374.c"  // <--- This will import your code so we can
...
int main()
{
    ...
    while (true)
    {
        ...
        {
            float a = printMovieReviews(MDB_head);
            printf("%f\n",a);
        }
        else if (choice == 6)
        {
            ...
            fgets(studio, MAX_STR_LEN, stdin);
            float a =queryReviewsByStudio(studio, MDB_head);
            printf("%f\n",a);
        }
        else if (choice == 7)
        {
            ...
            scanf("%d", &score);
            getchar();
            float a =queryReviewsByScore(score, MDB_head);
            printf("%f\n",a);
        }
        else if (choice == 8)
        {
