...
#include<stdio.h>
#include<stdlib.h>
#include"ingredient_graphs_1008831374.c"
...
int main()
{
   ...
   // owen
    /*printf("\n MyTest1****** Related ingredients for yessir:\n");
    related_ingredients("yessir");
    ...
    head=related_k_dist(head,"artichoke hearts",2,0);
    print_ingredients(head);
    head=deleteList(head);
    /*
    ...
    printf("\n MyTest3****** Related with restrictions, 'quinoa', 'artichoke hearts', k_source=1, k_dest=3 - Updated;\n");
    head=related_with_restrictions("quinoa","artichoke hearts",1,3);
    print_ingredients(head);
    head=deleteList(head);

    printf("\n MyTest4****** Related with restrictions, 'bananas', 'coconut', k_source=1, k_dest=1 - Updated;\n");
    head=related_with_restrictions("bananas","coconut",1,1);
    print_ingredients(head);
    head=deleteList(head);
    */
    ...
    printf("\n MyTest6****** substituting ingredient 'turkey' in recipe\n");
